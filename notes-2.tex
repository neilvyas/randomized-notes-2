...
Suppose we hold $i$ types of coupons already. What is the expected number of coupons we must collect until we receive a new type? Denote this expectation as $T_i$.
